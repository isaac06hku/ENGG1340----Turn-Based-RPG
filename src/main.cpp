...
void displayIntro(){
  ...
  std::cout << " | |_) |_ __ __ _ _ _ __    _ __ ___ | |_          " << std::endl;
  std::cout << " |  _ <| '__/ _` | | '_ \  | '__/ _ \| __|         " << std::endl;
  std::cout << " | |_) | | | (_| | | | | | | | | (_) | |_          " << std::endl;
  std::cout << " |____/|_|  \__,_|_|_| |_| |_|  \___/ \__|         " << std::endl;
  std::cout << "     /\      | |               | |                 " << std::endl;
  std::cout << "    /  \   __| |_   _____ _ __ | |_ _   _ _ __ ___ " << std::endl; 
  std::cout << "   / /\ \ / _` \ \ / / _ \  _ \| __| | | |  __/ _ \" << std::endl;
  std::cout << "  / ____ \ (_| |\ V /  __/ | | | |_| |_| | | |  __/" << std::endl;
